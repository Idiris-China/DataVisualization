...
vehicle <- read.csv("C:/Users/idris/Documents/JHML + Data Visualization/Homework 1/VehicleFailureDataUS.csv", header = TRUE)
str(vehicle)
View(vehicle)
...
i wanted to post in github repository called data  visualization can you create this Readme file  
